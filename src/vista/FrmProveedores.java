		...
		tblProveedor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					...
					IntCompra.txtidProveeee.setText(tblProveedor.getValueAt(fila,0).toString());
					IntCompra.txtRazonSocialProv.setText(tblProveedor.getValueAt(fila, 1).toString());
					IntCompra.txtRucProv.setText(tblProveedor.getValueAt(fila,2).toString());
