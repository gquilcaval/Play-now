		...
		tblClientes.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					...
					int fila2 = tblClientes.getSelectedRow();
					IntVenta.txtCodigoCliente.setText(tblClientes.getValueAt(fila2, 0).toString());
					IntVenta.txtNombreCliente.setText(tblClientes.getValueAt(fila2,1).toString());
					IntVenta.txtApellidosCli.setText(tblClientes.getValueAt(fila2, 2).toString());
					dispose();
				} catch (Exception e2) {
